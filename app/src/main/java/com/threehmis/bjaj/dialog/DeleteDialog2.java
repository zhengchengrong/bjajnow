...
import com.threehmis.bjaj.module.more.ActionRegistHistoryActivity;
 ...
 *         记录里只有删除的dialog
 */
public class DeleteDialog2 extends android.app.Dialog implements
    ...
    public DeleteDialog2(android.content.Context Context, String id, String whichnoe) {
    ...
    public DeleteDialog2(android.content.Context context, int theme) {
        super(context, theme);
    }
                ...
                case RetrofitFactory.MSG_SUCESS:
                    ...
                    switch (whichnoe) {//广播刷新数据
                        case "抽查":
                            ...
                            intent.setAction(ActionRegistHistoryActivity.DATAREFRESH);
