...
public class WilldoAdapter extends RecyclerView.Adapter<WilldoAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_willdo_item, parent, false);
