/*
 * Copyright (c) zcr 2018. Lorem ipsum dolor sit amet, consectetur adipiscing elit.
...
public class WillDoSafeJDGZSHActivity extends BaseActivity {
    ...
    protected int attachLayoutRes() {
        return R.layout.activity_will_do_safe_jdgzsh;
    }
    ...
    protected void initViews() {
        ...
        mEt07.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                new DatePickerDialog(WillDoSafeJDGZSHActivity.this, onDateSetListener, mYear, mMonth, mDay).show();
            }
        });
    ...
    private void check() {
        ...
        if(TextUtils.isEmpty(mEt05.getText().toString())){
            RxToast.showToast("请输入告知书编号");
            return;
        }
        if(TextUtils.isEmpty(mEt06.getText().toString())){
            RxToast.showToast("请输入中止安全监督原因");
            return;
        }
