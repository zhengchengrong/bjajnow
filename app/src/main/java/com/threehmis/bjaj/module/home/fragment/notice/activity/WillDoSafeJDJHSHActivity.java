...
public class WillDoSafeJDJHSHActivity extends BaseActivity {
    ...
    protected void initViews() {
        ...
        mEt07.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                new DatePickerDialog(WillDoSafeJDJHSHActivity.this, onDateSetListener, mYear, mMonth, mDay).show();
            }
        });
